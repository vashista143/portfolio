...
const projects = [
  ...
  {
  id: 2,
    title: "Recruitoo AI Recruitment Platform",
  description:
    "A full fledged AI powered recruitment platform with separate applicant and recruiter dashboards. Applicants can register login build profiles upload resumes and apply for jobs seamlessly. Recruiters can create update delete and manage job postings while tracking applications efficiently. Integrated Grok AI based applicant shortlisting system to help recruiters identify the best candidates quickly.",
  image: "projects/recruitooo.png",
  tags: ["React", "Expressjs", "MongoDB", "JWT", "AI Integration"],
  demoUrl: "https://recruitoooo.vercel.app/",
  ...
  tags: ["React", "Expressjs", "MongoDB", "Chart.js"],
  demoUrl: "https://expense-tracker-livid-beta-98.vercel.app/",
  githubUrl: "https://github.com/vashista143/expense-tracker-"
}
];
